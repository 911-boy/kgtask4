...
/**
 * ========================================================================
 * ПУНКТ 1: ЗАГРУЗКА И ЧТЕНИЕ МОДЕЛЕЙ - КАЧЕСТВЕННАЯ РЕАЛИЗАЦИЯ ObjReader
 * ========================================================================
 * Класс для чтения OBJ-файлов. Реализован согласно принципам из методички:
 * - Методы принимают только то, что им нужно для работы
 * - Возвращают только то, что могут создать
 * - Исключение - индекс строки для вывода сообщений об ошибках
 ...
 * - Нормали (vn)
 * - Полигоны (f) с различными форматами
 */
public class ObjReader {
	...
	/**
	 * ПУНКТ 1: Основной метод чтения OBJ-файла.
	 * Парсит содержимое файла и создает объект Model.
	 * 
	 * @param fileContent содержимое OBJ-файла в виде строки
	 * @return объект Model с загруженными данными
	 */
	...
	/**
	 * ПУНКТ 1: Парсинг вершины (v x y z).
	 * Метод имеет модификатор protected для тестирования.
	 * Выбрасывает ObjReaderException при ошибках парсинга.
	 */
	...
	/**
	 * ПУНКТ 1: Парсинг текстурной координаты (vt u v).
	 */
	...
	/**
	 * ПУНКТ 1: Парсинг нормали (vn x y z).
	 */
	...
	/**
	 * ПУНКТ 1: Парсинг полигона (f v1/vt1/vn1 v2/vt2/vn2 ...).
	 * Поддерживает различные форматы: f v, f v/vt, f v//vn, f v/vt/vn
	 */
